...
xfits = fits_G2M[inds]
nconv = 4
@time CIs_G2M_PL = get_confidence_intervals(xfits, xdata, get_confidence_intervals_PL; nconv, time_limit=60.0)
...
@save fitpath*"phase_th_ind_CI_results.jld2" th_ind_res